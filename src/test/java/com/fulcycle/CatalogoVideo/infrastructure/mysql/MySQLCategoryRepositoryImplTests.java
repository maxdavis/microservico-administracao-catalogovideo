...
public class MySQLCategoryRepositoryImplTests {
    ...
    @Test
    public void findAllCategorires() {
    ...
    public void findByIdCategory(){
        ...
        CategoryPersistence input = CategoryPersistence.from(entity1);
        
        doReturn(Optional.of(input))
                .when(springDataRepository)
                .findById(entity1.getId());
                
        Optional<Category> actual = repository.findById(entity1.getId());
    ...
    public void deleteCategory(){
        ...
        doNothing()
                .when(springDataRepository)
                .deleteById(entity1.getId());
        repository.remove(entity1.getId());

        verify(springDataRepository, times(1)).deleteById(entity1.getId());
